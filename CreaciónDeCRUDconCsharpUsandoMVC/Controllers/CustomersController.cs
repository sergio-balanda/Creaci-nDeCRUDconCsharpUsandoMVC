...
namespace CreaciónDeCRUDconCsharpUsandoMVC.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CompanyName,Contact_name")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_customer,CompanyName,Contact_name")] Customer customer)
        {
            if (ModelState.IsValid)
            {
