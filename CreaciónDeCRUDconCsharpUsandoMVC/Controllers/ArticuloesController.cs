...
namespace CreaciónDeCRUDconCsharpUsandoMVC.Controllers
{
    ...
    public class ArticuloesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Product_name,Unit_price")] Articulo articulo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_articulo,Product_name,Unit_price")] Articulo articulo)
        {
            if (ModelState.IsValid)
            {
