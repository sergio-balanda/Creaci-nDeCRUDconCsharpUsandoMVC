...
namespace CreaciónDeCRUDconCsharpUsandoMVC.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_order,Order_date,Id_Customer")] Orders orders)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_order,Order_date,Id_Customer")] Orders orders)
        {
            if (ModelState.IsValid)
            {
